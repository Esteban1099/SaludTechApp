...
from src.procesamiento_imagen.modulos.procesamiento_imagen.aplicacion.dto import ImagenMedicaDTO, DemografiaDTO, RegionAnatomicaDTO, \
    DiagnosticoDTO, AtributoDTO
from src.procesamiento_imagen.modulos.procesamiento_imagen.dominio.entidades import ImagenMedica, Demografia, RegionAnatomica, \
    Diagnostico, Atributo
from src.procesamiento_imagen.modulos.procesamiento_imagen.dominio.objetos_valor import Modalidad, GrupoEdad, Sexo, Etnia, \
    CategoriaAnatomica
from src.procesamiento_imagen.seedwork.aplicacion.mapeadores import Mapeador as AplMap
from src.procesamiento_imagen.seedwork.dominio.mapeadores import Mapeador as RepMap
...
class MapeadorImagenMedicaDTOJson(AplMap):
    ...
    def externo_a_dto(self, externo: dict) -> ImagenMedicaDTO:
        return ImagenMedicaDTO(
            url=externo.get('url', str),
            flag=externo.get('flag', int),
