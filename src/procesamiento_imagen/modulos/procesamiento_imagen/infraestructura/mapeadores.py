from src.procesamiento_imagen.modulos.procesamiento_imagen.dominio.entidades import Demografia, Diagnostico, RegionAnatomica, Atributo, \
    ImagenMedica
from src.procesamiento_imagen.modulos.procesamiento_imagen.infraestructura.dto import DemografiaDTO, DiagnosticoDTO, RegionAnatomicaDTO, \
...
class MapeadorImagenMedicaDTOEntity(Mapeador):
    ...
    def entidad_a_dto(self, imagen_medica: ImagenMedica) -> ImagenMedicaDTO:
        ...
        imagen_medica_dto.url =  str(imagen_medica.url)
