from src.sta3.modulos.procesamiento_imagen.dominio.entidades import Demografia, Diagnostico, RegionAnatomica, Atributo, \
    ImagenMedica
from src.sta3.modulos.procesamiento_imagen.infraestructura.dto import DemografiaDTO, DiagnosticoDTO, RegionAnatomicaDTO, \
