...
from src.sta3.modulos.procesamiento_imagen.aplicacion.dto import ImagenMedicaDTO, DemografiaDTO, RegionAnatomicaDTO, \
    DiagnosticoDTO, AtributoDTO
from src.sta3.modulos.procesamiento_imagen.dominio.entidades import ImagenMedica, Demografia, RegionAnatomica, \
    Diagnostico, Atributo
from src.sta3.modulos.procesamiento_imagen.dominio.objetos_valor import Modalidad, GrupoEdad, Sexo, Etnia, \
    CategoriaAnatomica
from src.sta3.seedwork.aplicacion.mapeadores import Mapeador as AplMap
from src.sta3.seedwork.dominio.mapeadores import Mapeador as RepMap
