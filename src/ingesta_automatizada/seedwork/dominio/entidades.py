...
from src.ingesta_automatizada.seedwork.dominio.excepciones import IdDebeSerInmutableExcepcion
from src.ingesta_automatizada.seedwork.dominio.mixins import ValidarReglasMixin
from src.ingesta_automatizada.seedwork.dominio.reglas import IdEntidadEsInmutable
