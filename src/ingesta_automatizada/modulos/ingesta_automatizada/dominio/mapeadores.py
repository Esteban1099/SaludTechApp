...
from src.ingesta_automatizada.modulos.ingesta_automatizada.aplicacion.dto import DemografiaDTO, AtributoDTO, \
    DiagnosticoDTO, \
    RegionAnatomicaDTO
from src.ingesta_automatizada.modulos.ingesta_automatizada.infraestructura.schema.v1.comandos import DemografiaRecord, \
    AtributoRecord, \
...
from src.ingesta_automatizada.seedwork.infraestructura.mapeadores import Mapeador as InfMap
