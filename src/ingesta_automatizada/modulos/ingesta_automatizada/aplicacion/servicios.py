from src.ingesta_automatizada.modulos.ingesta_automatizada.aplicacion.dto import ImagenMedicaDTO
...
from src.ingesta_automatizada.seedwork.aplicacion.servicio import Servicio
