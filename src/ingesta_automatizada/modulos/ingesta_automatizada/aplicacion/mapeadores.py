...
from src.ingesta_automatizada.modulos.ingesta_automatizada.aplicacion.dto import ImagenMedicaDTO, DemografiaDTO, \
    RegionAnatomicaDTO, \
    DiagnosticoDTO, AtributoDTO
from src.ingesta_automatizada.modulos.ingesta_automatizada.dominio.entidades import ImagenMedica, Demografia, \
    RegionAnatomica, \
    Diagnostico, Atributo
from src.ingesta_automatizada.modulos.ingesta_automatizada.dominio.objetos_valor import Modalidad, GrupoEdad, Sexo, \
    Etnia, \
    CategoriaAnatomica
from src.ingesta_automatizada.seedwork.aplicacion.mapeadores import Mapeador as AplMap
from src.ingesta_automatizada.seedwork.dominio.mapeadores import Mapeador as RepMap
